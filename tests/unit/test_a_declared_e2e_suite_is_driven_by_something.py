...
`scripts/e2e_stack.sh`, not `scripts/ray_e2e_stack.sh`, not `ci.yml`. That is the estate's most
...
#: Where a suite could be invoked from, other than a human typing `make`.
