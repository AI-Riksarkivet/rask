...
**Counted 2026-09-07, from the rows below rather than asserted: 219 tracked, 171 open, 48 struck.**
...
| Q8-15 | The live sweep reports 37 `storage_loss` and 79 `unreadable` datasets | high | Measured 2026-09-07 off the deployed `lineage_reconcile_sweep` record: `checked: 400, storage_loss: 37, unreadable: 79`. Every tick reports them and nothing acts on them. `storage_loss` means the graph names a dataset whose bytes the reconciler could not find; `unreadable` means it could not open one it was asked about. 116 of 400 is not noise, and neither number has ever been driven to a cause |
