...
Edit `/home/morgan/rask/package.json`: in the `"workspaces"` array, add `"components/apps/frontend"` alongside the existing `"compontens/apps/webapp"` and `"packages/ui"`. Leave everything else unchanged.
