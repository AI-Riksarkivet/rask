...
- *Evidence:* `grep -rn 'lineage' runners/*/pyproject.toml → empty` · `grep -rln lineage_kit runners/ → empty` · `packages/lineage-kit/src/lineage_kit/{stage,actor}.py — no consumers outside the package's own tests`
