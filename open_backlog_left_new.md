...
- **THE NON-FIXTURE TAIL IS FIVE NAMES, and four are already somebody else's row.**
  ...
  94-count name [[LH-141]] hands to [[LH-164]]. That leaves `models$auditprobe` (a probe) and
  `models$churn` as the only entries with no ready explanation — worth one look, not a campaign.
