...
Usage:
    uv run python components/scripts/download_iiif.py --batch A0060198 --out /tmp/iiif
    uv run python components/scripts/download_iiif.py --batch A0060198 --limit 3 --size 'full/,800/0/default.jpg'
"""
