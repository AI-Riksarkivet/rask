...
from core.models.pipelines import PipelineSpec
from core.schemas.chunk import ChunkBatches, StopResult, SubmitResult
...
def chunk_name(chunk_id: int, chunk_total: int, spec: PipelineSpec) -> str:
    ...
    `core.services.orchestrator.derive._slot_for`.
    """
