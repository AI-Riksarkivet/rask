...
from annotator.api.v1.endpoints.members import router as members_router
...
router = APIRouter()
for r in (annotations_router, assist_router, jobs_router, projects_router, project_events_router, members_router, tasks_router):
