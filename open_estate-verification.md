...
| 11b | `test_maintenance_e2e` skipped | **OPEN** | Needs `LANCE_E2E_GREPTIME_URL` + `LANCE_E2E_DAPR_TOKEN`. This is the suite that would settle whether row 6's compaction fix actually reclaims fragments on the live estate — the measurement that motivated it |
