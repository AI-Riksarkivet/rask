...
def sts_client(*, region: str, endpoint: str | None = None, unsigned: bool = False) -> Any:  # noqa: ANN401 — boto3 client has no public stub
    ...
    return boto3.client("sts", region_name=region, endpoint_url=endpoint, config=cfg)
