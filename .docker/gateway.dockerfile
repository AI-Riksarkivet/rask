...
LABEL org.opencontainers.image.created="${BUILD_DATE}" \
      ...
      org.opencontainers.image.description="rask gateway service — reverse-proxy API gateway, FastAPI on :8888"
...
RUN --network=none /opt/venv/bin/python /tmp/import-gate.py gateway && rm /tmp/import-gate.py
